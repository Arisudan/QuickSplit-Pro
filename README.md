...
*   **💳 Payments & Greedy Debt Settler**: Log manual payments or split remaining balances equally. A greedy debt simplification algorithm computes optimal, minimized peer-to-peer transfers with calculation math tooltips.
